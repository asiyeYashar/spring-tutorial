...
//    public String deletePurchaseInvoices(@PathVariable("id") Long id, Model model){
//
//        invoiceService.deleteById(id);
//        model.addAttribute("invoices", invoiceService.listAllInvoicesByInvoiceType(InvoiceType.PURCHASE));
